...
- [docs/fleet-dashboard.md](docs/fleet-dashboard.md) - the local read-only Fleet Dashboard, its lifecycle commands, state projection, freshness behavior, and security boundary.
